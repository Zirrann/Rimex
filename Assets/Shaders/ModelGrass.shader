Shader "Unlit/ModelGrass" {
    Properties {
        _Albedo1 ("Albedo 1", Color) = (1, 0, 0)
        _Albedo2 ("Albedo 2", Color) = (1, 0, 0)
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag (v2f i) : SV_Target {
                ...
                float4 tip = lerp(0.0f, _TipColor, i.uv.y * i.uv.y * (1.0 + _Scale));
                //return fixed4(i.chunkNum, 1.0f);
                //return i.noiseVal;
                //return col;

                /*  grassColor dosn't work, for now ret col   TODU   */
