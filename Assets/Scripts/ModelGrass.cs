...
/*        numThreadGroups = Mathf.CeilToInt(numInstancesPerChunk / 128.0f);
        ...
        initializeGrassShader.SetInt("_ChunkDensity", chunkDensity);
        initializeGrassShader.SetInt("_ChunkSize", chunkSize+1);
